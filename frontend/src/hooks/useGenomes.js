 ...
 */
export function useGenomeLoader(genomeId) {
    ...
    useEffect(() => {
        ...
        if (genome && activeGenomeId === id && loadedRef.current === id)
            return;
