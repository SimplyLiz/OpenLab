...
export function GenomeCircle() {
    ...
    const handleClick = useCallback((e) => {
        ...
        const hit = genome.genes.find((g) => clickPos >= g.start && clickPos <= g.end);
        selectGene(hit ?? null);
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "genome-circle-canvas", onClick: handleClick, style: { width: "100%", height: "600px", cursor: "pointer" } }));
}
